...
from serverV2.orchestrator.allocation.heaviness_bands import vram_floor_for
...
# ---------------------------------------------------------------------------
# Smoke test — `python -m serverV2.orchestrator.allocation.economy_allocation_strategy`
# ---------------------------------------------------------------------------
...
def _smoke() -> None:
    ...
    eevee_strategy = EconomyAllocationStrategy(registry, validators=[EngineCompatibilityValidator()])
