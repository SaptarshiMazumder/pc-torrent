const STATUS_MAP = {
  ...
  setting_up_docker: { color: "#f5a623", label: "Setting Up Docker" },
  downloading_image: { color: "#f5a623", label: "Downloading Image" },
  installing_image: { color: "#f5a623", label: "Installing Image" },
  registering: { color: "#f5a623", label: "Registering" },
