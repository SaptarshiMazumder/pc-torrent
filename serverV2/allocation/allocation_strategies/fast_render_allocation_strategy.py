...
from serverV2.allocation.allocation_strategies.allocation_helpers.allocation_heaviness_bands import band_for
...
# ---------------------------------------------------------------------------
# Smoke test — `python -m serverV2.allocation.allocation_strategies.fast_render_allocation_strategy`
# ---------------------------------------------------------------------------
